...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="padding: 10px 10px 10px 10px; margin-left: 33%">
        ...
        <div class="input-group input-group-top">
            ...
            <input type="text" class="form-control" style="width: 300px;" autofocus="autofocus" readonly="true" placeholder="用户身份证号" aria-describedby="basic-sfzh" id="sfzh" name="sfzh" />
        </div>
        <div class="input-group input-group-top">
            <span class="input-group-addon" id="basic-stuName" style="width: 152px;">考   生  名  称：</span>
            <input type="text" class="form-control" style="width: 300px;" autofocus="autofocus" readonly="true" placeholder="用户身份名称" aria-describedby="basic-stuName" id="stuName" name="stuName" />
        </div>
        <div class="input-group input-group-top">
            ...
            if ($("#form1").valid() == true) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        alert(reValue.message);
                        if (reValue.code == 1) {
                            window.location.href = "/reg_Login.aspx";
                        }
                    },
                    error: function (errdata) {
                        alert("后台数据错误");
